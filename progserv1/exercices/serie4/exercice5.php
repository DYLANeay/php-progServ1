...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $firstName = $_POST["firstName"]; //parce que firstName est défini comme étant le name de l'input correspondant
...
<body>
    ...
    <form action="exercice3.php" method="POST">
        ...
        <input type="text" id="firstName" name="firstName" value="<?php echo isset($firstName) ? $firstName : ''; ?>" minlength="2" required>

        <br>

        <label for="lastName">Nom :</label><br>
        <input type="text" id="lastName" name="lastName" value="<?php echo isset($lastName) ? $lastName : ''; ?>" minlength="2" required>
        ...
        <textarea id="message" name="message" minlength="2" maxlength="500"><?php echo isset($message) ? $message : ''; ?></textarea>
        <br>
